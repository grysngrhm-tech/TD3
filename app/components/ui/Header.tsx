                ...
                >
                  ...
                  <div className="py-1">
                    <button
                      ...
                      className="w-full px-4 py-2 text-left text-sm flex items-center gap-2 hover:bg-[var(--bg-hover)] text-text-primary"
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2 text-left text-sm flex items-center gap-2 hover:bg-[var(--bg-hover)] text-error"
