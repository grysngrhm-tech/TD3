...
export function LoanStatusTab({ 
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Draws and Payoff Row - 2/3 and 1/3 split */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Draws Section - Takes 2/3 */}
        <div className="lg:col-span-2 card-ios p-0 overflow-hidden">
          ...
          >
            <div className="mb-4">
              ...
              <p className="text-xs mt-1" style={{ color: 'var(--text-muted)' }}>
                Record payoff to complete loan
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-ios-sm font-medium transition-all text-sm"
                style={{ 
