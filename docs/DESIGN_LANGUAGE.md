...
| Swatch | Hex | Usage |
|--------|-----|-------|
| ![#FEF2F2](https://via.placeholder.com/20/FEF2F2/FEF2F2) | `#FEF2F2` | Lightest tint |
| ![#950606](https://via.placeholder.com/20/950606/950606) | `#950606` | Primary (light mode) |
| ![#DC2626](https://via.placeholder.com/20/DC2626/DC2626) | `#DC2626` | Primary (dark mode) |
| ![#320202](https://via.placeholder.com/20/320202/320202) | `#320202` | Darkest shade |
